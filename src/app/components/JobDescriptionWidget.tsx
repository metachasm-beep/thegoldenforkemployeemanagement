  ...
  if (role === 'Sales Executive') {
    return (
      <div className="text-xs text-gray-600 dark:text-gray-400 space-y-3">
        ...
        <p className="leading-relaxed">Generate revenue through consistent outreach and effectively matching solutions to client needs, culminating in monthly subscription purchases via the product portal.</p>
        ...
        <ul className="list-disc pl-4 space-y-1">
          ...
          <li><strong>Closing:</strong> Monthly subscriptions only.</li>
    ...
    return (
      <div className="text-xs text-gray-600 dark:text-gray-400 space-y-3">
        ...
        <ul className="list-disc pl-4 space-y-1">
          ...
          <li><strong>Leadership Incentive:</strong> ₹1,000 bonus per monthly subscription closed by squad.</li>
        </ul>
      </div>
    );
  }
