...
const endMarker = '<div ref={messagesEndRef} />\n            </div>';
              ...
              <div className={\`max-w-[70%] \${isMe ? 'items-end' : 'items-start'} flex flex-col relative\`}>
                ...
                <div className="relative flex items-center gap-2 group/msg">
                  {isMe && !isImpersonating && (
                    <motion.div initial={{opacity:0, scale:0.9}} whileHover={{scale:1.05}} animate={{opacity:0}} className="opacity-0 group-hover/msg:opacity-100 transition-all flex gap-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 p-1 absolute right-full mr-2 top-0 z-10">
                  ...
                  {!isMe && !isImpersonating && (
                    <motion.div initial={{opacity:0, scale:0.9}} whileHover={{scale:1.05}} animate={{opacity:0}} className="opacity-0 group-hover/msg:opacity-100 transition-all flex gap-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 p-1 absolute left-full ml-2 top-0 z-10">
