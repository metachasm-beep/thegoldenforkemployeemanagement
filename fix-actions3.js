...
code = code.replace(/if \(me\.role === 'Sales Executive' && them\.role === 'Sales Executive'\) \{\s*throw new Error\('Sales Executives cannot direct message each other\.'\);\s*\}/, `if (me.role === 'Sales Executive' && them.role !== 'HR' && them.role !== 'System Bot') {
